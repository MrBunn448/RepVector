...
*   **Main Flow:**
    ...
    2. User enters their email, a secure password, and a password confirmation.
...
*   **Preconditions:** User is authenticated.
*   **Main Flow:**
    1. User navigates to the Settings/Preferences page.
    2. User toggles weight units (KG/LBS) or distance units (KM/Miles).
...
*   **Main Flow:**
    1. User navigates to the Admin Registration page.
    2. User enters account details and the secret key.
...
*   **Preconditions:** User is authenticated.
*   **Main Flow:**
    1. User clicks "Create New Exercise".
    2. User enters name, description, type, and primary muscle group.
...
*   **Main Flow:**
    1. Admin creates, edits, or deletes an exercise.
...
*   **Preconditions:** User is authenticated.
*   **Main Flow:**
    1. User navigates to the Workouts page.
...
*   **Preconditions:** User is authenticated.
*   **Main Flow:**
    1. User enters a name (e.g., "Full Body A") and description.
    2. User adds one or more exercises from the catalog.
    3. User defines target sets and reps for each exercise.
...
*   **Main Flow:**
    1. User performs a set of an exercise.
    2. User enters weight, reps, and RPE into the active session interface.
...
*   **Main Flow:**
    1. User selects a specific past session.
